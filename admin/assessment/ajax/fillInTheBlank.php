...
$query = "Insert into Assessment (assessment_module, assessment_type, assessment_order, created_by, created_on) Values ('$module', 'Fill in the Blank','$assessment_order', '$user_id', NOW())";
...
<label>Type the stem of your fill in the blank question here.</label><br /><br />
